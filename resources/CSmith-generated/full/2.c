...
static volatile int32_t g_3 = 0x6D7BE7E5L;/* VOLATILE GLOBAL g_3 */
static int32_t g_4 = 0x9B8BC588L;
...
{ /* block id: 0 */
    int32_t l_14 = 9L;
    for (g_4 = (-25); (g_4 > (-27)); g_4 = safe_sub_func_int32_t_s_s(g_4, 3))
    { /* block id: 3 */
        int32_t *l_8 = &g_9;
        int32_t *l_10 = &g_9;
        uint32_t l_11 = 0x38B6B0E1L;
        g_7 |= g_2;
        ++l_11;
    }
    return l_14;
